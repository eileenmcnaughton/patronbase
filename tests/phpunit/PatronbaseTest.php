 ...
 * @group headless
 */
class PatronbaseTest extends TestCase implements HeadlessInterface, HookInterface, TransactionalInterface {
  ...
  public function testImport():void {
    Patronbase::import(FALSE)
      //->setDirectory(__DIR__ . '/data')
      ->execute();
